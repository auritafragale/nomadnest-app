    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {currentRole === "sitter"
              ? "Add home and pet listings to your account. You'll be able to create listings for your pets and find nomads when you travel."
              : "Add house sitting to your account. You'll be able to browse sits and apply to take care of pets while traveling."}
          </DialogDescription>
        </DialogHeader>
