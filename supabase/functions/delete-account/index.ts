...
serve(async (req) => {
  ...
  // Verify the caller is who they say they are using the anon client first.
  ...
  // Use service-role client to call auth.admin.deleteUser — the only call that
  // actually removes the auth.users record.
